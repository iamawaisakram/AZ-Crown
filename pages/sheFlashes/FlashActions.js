...
class FlashActions extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      ...
      >
        ...
        <View style={styles.actionPanel}>
          <View style={styles.trainingPanel}>
            <View style={styles.cell}>
              <Text style={styles.inputTitle}>Flash Name</Text>
            </View>
            <View style={styles.cell}>
              <Text style={styles.inputTitle}>Upload Flash</Text>
            </View>
            <View style={styles.cell}>
              <Text style={styles.inputTitle}>Flash Link</Text>
            </View>
          </View>
          <View style={styles.trainingPanel}>
            <View style={styles.cell}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('SheFlashes')}
        >
